-- Agrega las armas a la tabla 'compatable_weapon_hashes' que se verán en la espalda del jugador (puedes usar los GetHashKey(...) si no conoces el hash de las armas) --
local SETTINGS = {
    back_bone = 24816,
    x = 0.075,
    y = -0.15,
    ...
    compatable_weapon_hashes = {
      ...
      -- ["w_sg_sawnoff"] = 2017895192 no se ve, quizás demasiado pequeña?
      -- launchers:
    }
}
...
Citizen.CreateThread(function()
  while true do
      ...
      -- Ataja si el jugador lleva un arma larga --
